...
const routes = [
  ...
  /* 用户门户路由 */
  {
    ...
    children: [
      ...
      { path: 'health-management', name: 'PortalHealthManagement', component: () => import('@/views/portal/HealthManagement.vue'), meta: { title: '健康管理' } },
  ...
  /* 医生路由 */
  {
    ...
    children: [
      ...
      { path: 'followups', name: 'DoctorFollowups', component: () => import('@/views/doctor/Followups.vue'), meta: { title: '随访管理' } },
